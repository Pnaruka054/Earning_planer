...
const Home = () => {
    ...
    }, [isTyping, typingIndex, currentImageIndex]);
    ...
    return (
        <div>
            ...
            <div className="container mt-5 text-center">
                <hr />
                <h2 className="mb-4 style_underline">Our Paid Courses</h2>
                <div className="row">
            ...
            <div id="why_choose_us" className="container mt-5">
                <div className="text-center">
                    <hr />
                    <h2 className="mb-4 style_underline">Why Choose Us?</h2>
                </div>
                <div className="d-flex">
                    ...
                    <div className="d-none d-md-inline-block" data-aos="fade-left" data-aos-anchor-placement="top-bottom">
            ...
            <div className="container mt-5 text-center">
                <hr />
                <h2 className="mb-4 style_underline">Our Free Courses</h2>
                <div className="row">
            ...
            <div className="container mt-5">
                <div className="channel-info card shadow-sm p-4">
                    <div className="text-center">
                        <h2 className="mb-4 style_underline">Subscribe Our Channel</h2>
                    </div>
                    {channelData && (
            ...
            <div id="contactForm" className="container my-5">
                <div className="text-center">
                    <h2 className="text-center mb-4 style_underline">Send Us A Message</h2>
                </div>
                <div className="d-flex justify-content-between">
                    <div className="flex-fill me-3" data-aos="fade-right" data-aos-delay="200">
                    ...
                    <div className="flex-shrink-0 d-none d-lg-block" data-aos="fade-left" data-aos-delay="500">
                        <img src="ContactUs2.gif" alt="Contact Us" className="img-fluid" style={{ marginTop: "-50px" }} />
                    </div>
                </div>
            </div>
